...
% CONTACT INFORMATION
%====================
\def\name{Brian Naklycky} % Name Here
\def\phone{(609) 356-4306}
\def\city{Austin, TX}
\def\email{brian-nak1@hotmail.com}
\def\LinkedIn{briannaklycky} % linkedin.com/in/______
\def\github{brianakl} % github username
...
\section{Projects}
\input{sections/independent_projects}
